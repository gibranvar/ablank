...
export function Positioning() {
  ...
  useGSAP(
    () => {
      ...
      // 2. TIMELINE AUTOMÁTICA ULTRA-LENTA
      ...
      // C. Cambio atmosférico: scale a 1.2 (antes 3) para que no manche toda la pantalla
      ...
      tl.to('.core-beam', 
        { height: '300px', opacity: 1, duration: 3, ease: 'power2.inOut' }, 
        '-=2'
      );
    },
    { scope: containerRef }
  ...
  return (
    <section ref={containerRef} className="relative w-full py-32 md:py-48 overflow-hidden bg-[#020202] flex flex-col items-center justify-center perspective-[2000px]">
      
      {/* =========================================
          AURORAS ATMOSFÉRICAS
          ========================================= */}
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="aurora-red absolute top-[20%] left-[30%] w-[350px] h-[350px] bg-red-600/20 blur-[80px] rounded-full" />
        <div className="aurora-orange absolute bottom-[20%] right-[30%] w-[400px] h-[400px] bg-orange-500/15 blur-[80px] rounded-full" />
        <div className="aurora-blue absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#0175ff]/20 blur-[150px] rounded-full opacity-0" />
      </div>
      ...
      {/* =========================================
          TEXTOS (Ahora con mb-24/mb-32 para separarlos de las cartas)
          ========================================= */}
      <div className="relative w-full h-[140px] flex items-center justify-center z-30 pointer-events-none mt-10 mb-24 md:mb-32">
        ...
        <div className="text-problem absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 mb-4 shadow-[inset_0_1px_4px_rgba(255,255,255,0.1)] backdrop-blur-md">
      ...
      {/* =========================================
          EL TECH STACK 3D (Ahora con mt-10/mt-16 para bajar más)
          ========================================= */}
      <div className="relative flex-1 w-full max-w-[500px] flex items-center justify-center z-20 scale-75 md:scale-100 mt-10 md:mt-16">
        ...
        >
          {/* Rayo de luz central actualizado al azul marca */}
          <div 
